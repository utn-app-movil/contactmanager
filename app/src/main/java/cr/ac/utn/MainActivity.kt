...
import cr.ac.utn.contactmanager.ContactListActivity
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnCustomList = findViewById<Button>(R.id.btn_custom_list)
        btnCustomList.setOnClickListener(View.OnClickListener {
            util.openActivity(this, customList::class.java)
        })
    }
